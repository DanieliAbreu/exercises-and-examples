...
print('''True and True
 Unica operação com o and que retorna
 verdadeiro : ''')
print(True and True)
print()
...
#RExemplos de respostas com valores booleanos
